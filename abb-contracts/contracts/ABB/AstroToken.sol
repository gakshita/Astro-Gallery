...
contract AstroToken is IERC20 {
    ...
    uint256 private constant startingSupply = 5_000_000;
    string private constant _name = "Astro Token";
    string private constant _symbol = "ABB";
    ...
    uint256 private _maxTxAmount = (_tTotal * 33) / 10000;
    ...
    {
        require(
            (_tTotal * percent) / divisor >= ((_tTotal * 2) / 100),
